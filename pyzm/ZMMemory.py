...
class ZMMemory:
    def __init__(self, api=None, path="/dev/shm", mid=None, globs: Optional[GlobalConfig] = None):
        if globs:
            self.globs = globs
        self.api = api
    ...
    def _read(self):
        ...
        TriggerData = namedtuple(
            "TriggerData", "size trigger_state trigger_score padding trigger_cause trigger_text trigger_showtext"
        )
